...
config.SERVER_NAME		= "auth.local"
config.ALLOWED_SERVER_NAMES	= ["localhost", "localhost:8443", "auth.local", "127.0.0.1", "127.0.0.1:8443"];
...
config.CA_CERT_PATH		= "../datasetu-ca/ca.datasetu.org.crt";
